...
create table data (meas_id serial, chan_id integer references channel_names, dt timestamp,
		value real, constraint chan_dt_unique primary key (chan_id,dt) ) order by dt;
